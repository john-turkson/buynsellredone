                                ...
                                <div className="flex flex-col items-center justify-center gap-y-4">
                                    ...
                                    <div className="w-full">
                                        <FormField
                                            ...
                                            id={"price"}
                                            type="number"
                                            touched={formik.touched.price || false}
                                    ...
                                    <div className="w-full">
                                        <div className="flex items-center justify-center w-full">
                                            <label
                                                ...
                                                className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:bg-neutral-800 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-neutral-600"
                                            >
                                            ...
                                            {files.map((fileObj, index) => (
                                                <div key={index} className="relative p-2 bg-gray-100 rounded-lg dark:bg-slate-600">
                                                    ...
                                                    <div className="flex items-center justify-between text-sm mb-1">
                                                        <span className="text-gray-600 dark:text-gray-300 overflow-hidden text-ellipsis whitespace-nowrap">
                                                            {fileObj.name}
                                                        </span>
                                                        <button
                                                            type="button"
