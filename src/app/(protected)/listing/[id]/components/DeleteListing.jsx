...
import { deleteAllImages } from "@/utils/helper-functions";
...
export default function DeleteListing({ listing }) {
    ...
    const handleDeleteListing = async () => {
        ...
        if (deleteResponse.status === 200) {
            ...
            const response = await axios.delete(`/api/delete-listing?id=${listing._id}`)
    ...
    return (
        <>
            <button
                type="button"
                className="my-4 py-3 px-4 text-center w-full inline-flex justify-center gap-x-2 text-sm font-medium rounded-lg border border-red-500 text-red-500 hover:border-red-400 hover:text-red-400 focus:outline-none focus:border-red-400 focus:text-red-400 disabled:opacity-50 disabled:pointer-events-none"
